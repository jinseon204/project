...
%>
<jsp:forward page="WEB-INF/member/agreement.jsp"></jsp:forward> 
<%
  return;
}
%>
...
<html>
	...
	<body class="index is-preload">
		<div id="page-wrapper">
					...
					<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="index.jsp">당신의 <span>이야기를 들려주세요</span></a></h1>
					<nav id="nav">
						<ul>
							...
							<li class="submenu">
								<a href="#">Layouts</a>
								<ul>
									<li><a href="left-sidebar.jsp">절차안내</a></li>
			    ...
			    <li><a href="#" onclick="location.href='index.jsp?agreement'"  class="button primary">회원가입</a></li>
								
							
				<li><a href="#"  onclick="location.href=''"  class="button primary">Sign Up</a></li>
							<ul>
					...
					<div class="inner">
						...
						<footer>
							<ul class="buttons stacked">
								<li><a href="#main" class="button fit scrolly">공증이란</a></li>
							</ul>
						</footer>
